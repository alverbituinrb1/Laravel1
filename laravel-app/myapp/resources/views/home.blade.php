...
<body class="flex items-center justify-center h-screen bg-gradient-to-r from-white-500 to-green-600 relative overflow-hidden">
    ...
    <h1 class="text-3xl font-bold text-white z-10">PAGE</h1>
</body>
